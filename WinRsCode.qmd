...
ggplot(aes(x = Gender, y = QualityofSleep), data = sleep_data) + stat_summary(fun.y = "mean", geom = "bar")
...
ggplot(aes(x = Gender, y = SleepDuration), data = sleep_data) + stat_summary(fun.y = "mean", geom = "bar")
...
ggplot(aes(x = Occupation, y = QualityofSleep), data = sleep_data) + stat_summary(fun.y = "mean", geom = "bar")
...
ggplot(aes(x = Occupation, y = SleepDuration), data = sleep_data) + stat_summary(fun.y = "mean", geom = "bar")
...
ggplot(aes(x = Age, y = QualityofSleep), data = sleep_data) + stat_summary(fun.y = "mean", geom = "Density")

```

## Average Time Slept by Age
...
ggplot(aes(x = Age, y = SleepDuration), data = sleep_data) + stat_summary(fun.y = "mean", geom = "Density")
...
ggplot(aes(x = SleepDisorder, y = QualityofSleep), data = sleep_data) + stat_summary(fun.y = "mean", geom = "bar")
...
ggplot(aes(x = SleepDisorder, y = SleepDuration), data = sleep_data) + stat_summary(fun.y = "mean", geom = "bar")
...
ggplot(aes(x = PhysicalActivityLevel, y = QualityofSleep), data = sleep_data) + stat_summary(fun.y = "mean", geom = "bar")

```

## Average Time Slept by Physical Activity Level
...
ggplot(aes(x = PhysicalActivityLevel, y = SleepDuration), data = sleep_data) + stat_summary(fun.y = "mean", geom = "bar")
...
ggplot(sleep_data, aes(x = PhysicalActivityLevel, y = QualityofSleep)) +
  geom_beeswarm()
